...
```bash
python sgp4.py <tle_file>              # 指定 TLE 文件，外推 10 分钟
...
```bash
python sgp4.py --hpop                  # 使用 HPOP 高精度外推，默认 10 分钟
...
-m, --minutes MINUTES  外推时间 (分钟，从当前时刻起算)，默认：10 分钟
```
